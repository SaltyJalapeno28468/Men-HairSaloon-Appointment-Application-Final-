...
//                                msg.setText(Html.fromHtml("<b> No Record Found !  </b>"));
                            ...
                            Toast.makeText(Add_Appointment.this, "JSONException ", Toast.LENGTH_LONG).show();
                            e.printStackTrace();
...
//                            Toast.makeText(Search_Vehicle_Activity.this, response, Toast.LENGTH_LONG).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(Add_Appointment.this, "Error " + error.getMessage(), Toast.LENGTH_LONG).show();
                    }
                }) {
...
//                salon_service_price_arr[i] = jb.getString(String.valueOf(final_price));
            ...
            RecyclerView.LayoutManager mLayoutManager = new GridLayoutManager(Add_Appointment.this, 1);
            ...
            Ad_Salon_Service_List ad_salon_service_list = new Ad_Salon_Service_List(Add_Appointment.this, salon_service_id_arr, salon_service_type_arr,
...
//            msg.setText(Html.fromHtml("<b> Select Violation Type !  </b>"));
            Toast.makeText(Add_Appointment.this, "Select Any Salon Service " + check_id, Toast.LENGTH_LONG).show();
        } else {
