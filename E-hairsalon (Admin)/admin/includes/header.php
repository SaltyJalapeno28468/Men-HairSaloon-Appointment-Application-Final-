    ...
    <div class="header-right">
        <div class="profile_details_left"><!--notifications of menu start -->
            <ul class="nofitications-dropdown">
                ...
                <?php
                $ret1 = mysqli_query($con, "select ta.id,ta.user_id,tu.name from tbl_appointment as ta left join tbl_user as tu on tu.id=ta.user_id where appointment_status=''");
