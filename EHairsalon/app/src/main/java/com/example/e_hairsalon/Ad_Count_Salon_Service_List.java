...
public class Ad_Count_Salon_Service_List extends RecyclerView.Adapter<Ad_Count_Salon_Service_List.HorizontalViewHolder> {
    ...
    public Ad_Count_Salon_Service_List(Activity context, String[] salonServiceIdArr, String[] salonServiceTypeArr, String[] salonServiceTimeArr, String[] salonServicePriceArr, String[] optionChecked, Ad_Salon_Service_List.OnItemClickListener listener) {
    ...
    public HorizontalViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view=inflater.inflate(R.layout.salon_service_list_count_item,parent,false);
        return new Ad_Count_Salon_Service_List.HorizontalViewHolder(view);
    }
