...
public class SalonServiceLVAdapter extends RecyclerView.Adapter<SalonServiceLVAdapter.ViewHolder> {
    ...
    public SalonServiceLVAdapter(Context context, ArrayList<SalonServiceLVModel> salonServiceLVModelArrayList, ItemClickListener itemClickListener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new SalonServiceLVAdapter.ViewHolder(view);
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.btn_appoint.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context.getApplicationContext(), Add_Appointment.class);
                intent.putExtra("URL", "");
