...
////        echo "insert into  tbl_service(service_name,service_time,service_price,service_discount,package_type) value('$sername','$service_time','$service_price','$service_discount','$package_type')";
//        $query = mysqli_query($con, "insert into  tbl_service(service_name,service_time,service_price,service_discount,package_type) value('$sername','$service_time','$service_price','$service_discount','$package_type')");
//        if ($query) {
                    ...
                    <div class="main-page">
                        <div class="forms">
                            ...
                            <div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
                                ...
                                <div class="form-body">
                                    <form action="add-services-php.php" method="post" enctype="multipart/form-data">
